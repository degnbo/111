...
class Page1{
    ...
    public function show() {
        ...
        $up_page = $up_row > 0 ? '<li><a class="bigwidth" href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '';

        //下一页
        $down_row  = $this->nowPage + 1;
        $down_page = ($down_row <= $this->totalPages) ? '<li><a class="bigwidth" href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a></li>' : '';
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<div style='margin:0px auto;width:500px'>{$page_str}</div>";
    }
}
