                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <form action="<?php echo U('Course/lis');?>" method="get">
                                ...
                                <table class="table table-striped table-bordered table-hover " id="editable" >
                                    ...
                                    <tbody>
                                        <?php if(is_array($dlist)): foreach($dlist as $k=>$vo): ?><tr class="gradeU">
                                                ...
                                                <td class="jz xqy" mid="<?php echo ($vo["id"]); ?>"><?php if($vo["is_nav"] == 1): ?><img xs='1' src="/Public/Admin/img/yes.gif"/><?php else: ?>
                                                    <img xs='2' src="/Public/Admin/img/no.gif"/><?php endif; ?>
                                                </td>
                                                <td class="jz"><?php echo date("Y-m-d H:i:s",$vo['start_time']);?></td>
                                                <td class="jz">
                                                    <a href="<?php echo U('Course/ewm',array('aid'=>$vo['id']));?>" >生成签到二维码</a>
                                                    <a href="<?php echo U('Course/edit',array('id'=>$vo['id'],'p'=>I('get.p')));?>" >
