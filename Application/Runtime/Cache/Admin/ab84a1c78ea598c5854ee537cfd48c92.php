    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="ibox ">
                ...
                <div class="">
                    <a onclick="fnClickAddRow();" href="javascript:void(0)" class="btn btn-primary ">角色列表</a>
                </div>
                <div class="ibox-content">
                    <form role="form" id="form" action="<?php echo U('Role/add');?>" method="post">
                        <div class="form-group">
                            <label>角色名称</label>
                            <input type="text" placeholder="请输入角色名称" datatype="*1-20"
                        ...
                        <div class="form-group">
                            <?php if(is_array($plist)): foreach($plist as $key=>$vo): ?><input type="checkbox" name="pri_id[]" level="<?php echo ($vo["level"]); ?>"value="<?php echo ($vo["id"]); ?>"/><?php echo (str_repeat('--',$vo['level']*8)); echo ($vo["pri_name"]); ?><br><?php endforeach; endif; ?>
                        </div>
                        <div>
