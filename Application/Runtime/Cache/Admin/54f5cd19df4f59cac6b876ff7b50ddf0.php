        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                                 <span class="">
                                    <a onclick="javascript:void(0)" class="btn btn-primary ">会员列表</a>
                                </span>
                    <form action="<?php echo U('Member/lis');?>" method="get">
                ...
                <div class="ibox-content">
                    <table class="table table-striped table-bordered table-hover " id="editable" >
                        ...
                        <?php if(is_array($dlist)): foreach($dlist as $key=>$vo): ?><tr class="gradeU">
                                ...
                                <td class="jz"><img width="60px" height="60px" <?php if($vo["logo"] != ''): ?>src="<?php echo ($vo['logo']); ?>"<?php else: ?>src="/Public/Uploads/houtai.png"<?php endif; ?> /></td>
                                <td class="jz"><?php if($vo["sex"] == 1): ?>男<?php elseif($vo["sex"] == 2): ?>女<?php else: ?>未知<?php endif; ?></td>
                                <td class="jz"><?php if($vo["type"] == 1): ?>普通会员<?php else: ?>教练<?php endif; ?></td>
                                <td class="jz"><?php echo ($vo['phone']); ?></td>
                                <td class="jz"><?php if($vo["birth"] != 0): echo ($vo['birth']); else: ?>--<?php endif; ?></td>
                                <td class="jz"><?php echo date("Y-m-d H:i:s",$vo['addtime']);?></td>
                                <td class="jz">
                                    <a href="<?php echo U('Member/edit1',array('id'=>$vo['id'],'p'=>I('get.p')));?>">
                                        修改
                                    </a>
