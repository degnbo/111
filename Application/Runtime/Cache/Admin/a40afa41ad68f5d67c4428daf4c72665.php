                            ...
                            <div class="ibox-content">
                                ...
                                <table class="table table-striped table-bordered table-hover " id="editable" >
                                    ...
                                    <?php if(is_array($dlist)): foreach($dlist as $key=>$vo): ?><tr class="gradeU">
                                                ...
                                                <td class="jz"><?php echo ($vo["username"]); ?></td>
                                                <td class="jz"><?php echo ($vo["password"]); ?></td>
                                                <td class="jz"><?php echo ($vo["role_list"]); ?></td>
                                                <td class="jz xqy" mid="<?php echo ($vo["id"]); ?>">
                                                    <?php if($vo["is_deny"] == 0): ?><img xs='0' src="/Public/Admin/img/error.png"/><?php else: ?>
                                                        <img xs='1' src="/Public/Admin/img/true.png"/><?php endif; ?>
                                                </td>
                                                <td class="jz"><a href="<?php echo U('Admin/edit',array('id'=>$vo['id']));?>"><img src="/Public/Admin/img/icon_edit.gif"/></a>
                                                    <?php if(strpos($vo['role_id'],'1') === false): ?><a onclick="return confirm('你确定要删除')" href="<?php echo U('Admin/delete',array('id'=>$vo['id']));?>"><img src="/Public/Admin/img/icon_trash.gif"/></a><?php endif; ?>
                                                </td>
                                ...
                                <script>
                                    $(function(){
                                        $(".xqy").find('img').click(function() {
                                            var me=$(this);
                                            var url = "<?php echo U('Admin/ajaxChange');?>";
                                            ...
                                            if (val == 1) {
                                                $.post(url, {val: val, mid: mid},function(e){
                                                    if(e==1){
                                                        ...
                                                        me.attr('src', "/Public/Admin/img/error.png");
                                                        me.attr('xs', '0');
                                                    }
                                                },'html');
                                            } else {
                                                $.post(url, {val: val, mid: mid},function(e){
                                                    if(e==1){
                                                        ...
                                                        me.attr('src', "/Public/Admin/img/true.png");
                                                        me.attr('xs', '1');
                                                    }
                                                },'html');
                                            }
