                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <span class="">
                                    <a href="javascript:void(0);" class="btn btn-primary ">发布活动订单列表
                                    </a>
                                ...
                                <form action="<?php echo U('Order/lis1');?>" method="get">
                                ...
                                <table class="table table-striped table-bordered table-hover " id="editable" >
                                    ...
                                    <tbody>
                                        <?php if(is_array($dlist)): foreach($dlist as $k=>$vo): ?><tr class="gradeU">
                                                <td class="jz">
                                                    <?php if($vo["ordernum"] == ''): ?>--
                                                        <!--<?php echo "wxc767748b8c5bfa4b".time();?>-->
                                                        <?php else: echo ($vo["ordernum"]); endif; ?>
                                                </td>
                                                <td class="jz"><?php echo ($vo["tname"]); ?></td>
                                                <td class="jz"><?php echo ($vo["name"]); ?></td>
                                                <td class="jz"><?php echo date("Y-m-d H:i:s",$vo['addtime']);?></td>
                                                <td class="jz"><?php echo ($vo["number"]); ?></td>
                                                <td class="jz"><?php echo ($vo['number']*$vo['price']); ?></td>
                                                <td class="jz">
                                                    <?php if($vo["acode"] == 1): ?><span style="color: green">后台发布的活动</span>
                                                        <?php else: ?>
                                                        <?php if($vo["is_pay"] == 1): ?>已支付
                                                            <?php elseif($vo["is_pay"] == 0 ): ?>
                                                            未支付
                                                            <?php elseif($vo["is_pay"] == 2 ): ?>
                                                            退款中
                                                            <?php elseif($vo["is_pay"] == 3): ?>
                                                            签到，已退款
                                                            <?php elseif($vo["is_pay"] == 4): ?>
                                                            活动取消
                                                            <?php elseif($vo["is_pay"] == 5): ?>
                                                            非签到，已退款
                                                            <?php elseif($vo["is_pay"] == 6): ?>
                                                            未退款<?php endif; endif; ?>
                                                </td>
                                                <td class="jz">
                                                    <a href="<?php echo U('Order/lis2',array('id'=>$vo['id']));?>" >
                                                    活动订单</a>
                                                    <a href="<?php echo U('Order/lis3',array('id'=>$vo['id']));?>" >
                                                        活动评论</a>
                                                    <a href="<?php echo U('Order/pub_detail',array('id'=>$vo['id'],'p'=>I('get.p'),'paystatus'=>I('get.paystatus')));?>" >
