...
function GetJcrop(frame, input)
{
	...
	$("body").append('<iframe frameborder="0" name="frame" id="'+ frame +'" src="/Public/jcrop/index.php?imgurl='+ encodeURI(imgurl) +'&frame='+ frame +'&input='+ input +'&code='+Math.random()+'" allowtransparency="true" style="position:absolute;top:0;left:0;width:100%;height:100%;display:none;z-index:9999;" scrolling="no"></iframe>');
